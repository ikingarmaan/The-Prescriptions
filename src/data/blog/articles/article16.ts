...
export const article16: BlogArticle = {
  "id": "polypharmacy-elderly-prescription-safety-guide",
  "slug": "polypharmacy-elderly-prescription-safety-guide",
  "title": "Polypharmacy in Older Adults: Managing 5+ Daily Prescriptions and Avoiding Medication Cascades",
  "subtitle": "Deprescribing Pharmacology: The Beers Criteria, Prescribing Cascades, Anticholinergic Burden, and How to Protect Aging Loved Ones from Drug Toxicity",
  "excerpt": "Taking five, eight, or twelve different prescription pills every single day? Discover the hidden dangers of polypharmacy in older adults, learn how to identify dangerous 'prescribing cascades', and master the clinical art of safe deprescribing.",
  "category": "safety",
  ...
  "tableOfContents": [
    {
      "id": "introduction-the-pillbox-explosion-in-later-life",
      "title": "1. The Pillbox Explosion: When Medicine Becomes More Dangerous Than Disease"
    },
    {
      "id": "the-aging-body-altered-geriatric-pharmacokinetics",
      "title": "2. The Aging Body: How Kidneys, Liver, and Body Composition Alter Drug Clearance"
    },
    {
      "id": "the-deadly-trap-the-prescribing-cascade",
      "title": "3. The Prescribing Cascade: When a Side Effect Sparks a New Prescription"
    },
    {
      "id": "anticholinergic-burden-and-cognitive-decline",
      "title": "4. The Silent Threat: Cumulative Anticholinergic Burden, Delirium, and Falls"
    },
    {
      "id": "the-beers-criteria-identifying-potentially-inappropriate-medications",
      "title": "5. The Beers Criteria: What Every Caregiver Must Know About Inappropriate Drugs"
    },
    {
      "id": "the-science-of-deprescribing-safely-weaning-off-pills",
      "title": "6. The Art of Deprescribing: How Geriatricians Systematically Subtract Medications"
    },
    {
      "id": "master-high-risk-geriatric-medications-table",
      "title": "7. The Master Geriatric High-Risk Medications and Safer Alternatives Table"
    },
    {
      "id": "caregiver-action-plan-the-brown-bag-review",
      "title": "8. Actionable Caregiver Protocol: How to Conduct a Annual \"Brown Bag\" Medication Review"
    }
  ],
  "sections": [
    {
      "id": "introduction-the-pillbox-explosion-in-later-life",
      "heading": "1. The Pillbox Explosion: When Medicine Becomes More Dangerous Than Disease",
      "content": [
    ...
    {
      "id": "the-aging-body-altered-geriatric-pharmacokinetics",
      "heading": "2. The Aging Body: How Kidneys, Liver, and Body Composition Alter Drug Clearance",
      "content": [
    ...
    {
      "id": "the-deadly-trap-the-prescribing-cascade",
      "heading": "3. The Prescribing Cascade: When a Side Effect Sparks a New Prescription",
      "content": [
      ...
      "callout": {
        "type": "danger",
        "title": "The Prescribing Cascade Rule",
        "text": "Whenever an older adult develops a new medical symptom—such as fatigue, dizziness, confusion, or ankle swelling—always investigate active medications first before starting a new pill."
      }
    },
    {
      "id": "anticholinergic-burden-and-cognitive-decline",
      "heading": "4. The Silent Threat: Cumulative Anticholinergic Burden, Delirium, and Falls",
      "content": [
    ...
    {
      "id": "the-beers-criteria-identifying-potentially-inappropriate-medications",
      "heading": "5. The Beers Criteria: What Every Caregiver Must Know About Inappropriate Drugs",
      "content": [
    ...
    {
      "id": "the-science-of-deprescribing-safely-weaning-off-pills",
      "heading": "6. The Art of Deprescribing: How Geriatricians Systematically Subtract Medications",
      "content": [
      ...
      "quote": {
        "text": "Anyone can prescribe a pill. It takes an expert, compassionate clinician to carefully deprescribe an unnecessary medication and give an older adult their clarity back.",
        "author": "American Geriatrics Society Deprescribing Consortium"
      }
    },
    {
      "id": "master-high-risk-geriatric-medications-table",
      "heading": "7. The Master Geriatric High-Risk Medications and Safer Alternatives Table",
      "content": [
      ...
      "table": {
        "headers": [
          ...
          "Major Clinical Peril in Elderly",
          "Safer Evidence-Based Alternative"
        ],
        "rows": [
          [
            "First-Gen Antihistamines",
            "Diphenhydramine (Benadryl), Chlorpheniramine",
            "High anticholinergic burden, confusion, falls, urinary retention",
            "Second-gen non-sedating agents (cetirizine, fexofenadine)"
          ],
          [
            "Benzodiazepines & Z-Drugs",
            "Diazepam (Valium), Zolpidem (Ambien)",
            "Prolonged half-life, daytime sedation, severe hip fractures",
            "Non-pharmacological sleep hygiene, CBT-I, melatonin"
          ],
          [
            "Chronic Oral NSAIDs",
            "Ibuprofen, Naproxen, Diclofenac oral",
            "Peptic ulcer hemorrhage, acute renal failure, fluid retention",
            "Topical diclofenac gel, acetaminophen (monitored dose)"
          ],
          [
            "Tricyclic Antidepressants",
            "Amitriptyline, Doxepin, Imipramine",
            "Severe orthostatic hypotension, cardiac arrhythmias, dry mouth",
            "SSRIs (sertraline, escitalopram) at conservative starting doses"
          ],
          [
            "Sliding-Scale Regular Insulin",
            "Regular insulin sliding scales without basal",
            "High risk of severe hypoglycemic coma and death",
            "Standard basal insulin regimens with consistent carbohydrate dosing"
          ],
          [
            "Long-Acting Sulfonylureas",
            "Glyburide (Micronase)",
            "Prolonged, severe hypoglycemia due to active metabolites",
            "Glipizide, SGLT2 inhibitors, or DPP-4 inhibitors"
          ]
        ]
      }
    },
    {
      "id": "caregiver-action-plan-the-brown-bag-review",
      "heading": "8. Actionable Caregiver Protocol: How to Conduct a Annual \"Brown Bag\" Medication Review",
      "content": [
