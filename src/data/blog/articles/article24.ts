...
export const article24: BlogArticle = {
  "id": "asthma-copd-inhaler-prescriptions-spacer-technique",
  "slug": "asthma-copd-inhaler-prescriptions-spacer-technique",
  ...
  "excerpt": "A comprehensive patient guide to the master guide to inhaler prescriptions: relievers vs. preventers, spacers, and why mouth rinsing prevents oral thrush: clinical mechanisms, dosage timing, organ safety, and evidence-based guidance.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "content": [
        "• <a href=\"https://ginasthma.org/reports/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 font-bold underline decoration-teal-500/40 hover:decoration-teal-400 transition-colors\">Global Initiative for Asthma (GINA) - 2025 Global Strategy for Asthma Management and Prevention</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://pubmed.ncbi.nlm.nih.gov/27599723/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 font-bold underline decoration-teal-500/40 hover:decoration-teal-400 transition-colors\">National Library of Medicine (PubMed) - Inhaler Technique Errors in Patients with Asthma and COPD: A Systematic Review</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://www.lung.org/lung-health-diseases/lung-disease-lookup/asthma/treatment/devices\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 font-bold underline decoration-teal-500/40 hover:decoration-teal-400 transition-colors\">American Lung Association - How to Use a Metered-Dose Inhaler with a Spacer</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://www.mayoclinic.org/drugs-supplements/fluticasone-inhalation-route/proper-use/drg-20072813\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 font-bold underline decoration-teal-500/40 hover:decoration-teal-400 transition-colors\">Mayo Clinic Pulmonary Medicine - Inhaled Steroids: Preventing Fungal Infections (Thrush) and Hoarseness</a>: Evidence-based clinical guidelines and regulatory safety communications."
      ]
    }
  ],
