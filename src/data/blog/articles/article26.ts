...
export const article26: BlogArticle = {
  ...
  "excerpt": "A comprehensive patient guide to the complete guide to painkiller prescriptions: acetaminophen vs. nsaids, safe dosing, and organ protection: clinical mechanisms, dosage timing, organ safety, and evidence-based guidance.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "content": [
        "• <a href=\"https://www.fda.gov/drugs/safe-daily-use-acetaminophen\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 font-bold underline decoration-rose-500/40 hover:decoration-rose-400 transition-colors\">U.S. Food and Drug Administration (FDA) - Acetaminophen Toxicity and Overdose Prevention Guidance</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://pubmed.ncbi.nlm.nih.gov/30184428/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 font-bold underline decoration-rose-500/40 hover:decoration-rose-400 transition-colors\">National Library of Medicine (PubMed) - Cardiovascular and Renal Risks of Nonsteroidal Anti-inflammatory Drugs</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://gastro.org/guidelines/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 font-bold underline decoration-rose-500/40 hover:decoration-rose-400 transition-colors\">American Gastroenterological Association (AGA) - Prevention of NSAID-Related Gastrointestinal Complications</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://www.mayoclinic.org/diseases-conditions/heart-attack/expert-answers/nsaids-heart-attack-stroke/faq-20058475\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 font-bold underline decoration-rose-500/40 hover:decoration-rose-400 transition-colors\">Mayo Clinic Health Information - NSAIDs: Do They Increase My Risk of Heart Attack and Stroke?</a>: Evidence-based clinical guidelines and regulatory safety communications."
      ]
    }
  ],
