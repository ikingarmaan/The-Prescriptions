...
export const article21: BlogArticle = {
  "id": "blood-pressure-prescriptions-ace-arb-beta-blockers",
  "slug": "blood-pressure-prescriptions-ace-arb-beta-blockers",
  ...
  "excerpt": "A comprehensive patient guide to demystifying blood pressure prescriptions: ace inhibitors, arbs, beta-blockers, and calcium channel blockers explained: clinical mechanisms, dosage timing, organ safety, and evidence-based guidance.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "content": [
        "• <a href=\"https://www.heart.org/en/health-topics/high-blood-pressure\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-bold underline decoration-blue-500/40 hover:decoration-blue-400 transition-colors\">American Heart Association (AHA) - 2025 Comprehensive Guidelines for the Prevention, Detection, and Management of High Blood Pressure</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://pubmed.ncbi.nlm.nih.gov/31525287/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-bold underline decoration-blue-500/40 hover:decoration-blue-400 transition-colors\">National Library of Medicine (PubMed) - Comparative Effectiveness of ACE Inhibitors vs. ARBs in Primary Hypertension</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://www.who.int/publications/i/item/9789240033986\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-bold underline decoration-blue-500/40 hover:decoration-blue-400 transition-colors\">World Health Organization (WHO) - Guideline for the Pharmacological Treatment of Hypertension in Adults</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://www.mayoclinic.org/diseases-conditions/high-blood-pressure/in-depth/high-blood-pressure-medication/art-20046280\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-bold underline decoration-blue-500/40 hover:decoration-blue-400 transition-colors\">Mayo Clinic Cardiology - Blood Pressure Medications: Choosing the Right Class and Managing Side Effects</a>: Evidence-based clinical guidelines and regulatory safety communications."
      ]
    }
  ],
