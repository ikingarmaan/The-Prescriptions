...
export const article25: BlogArticle = {
  "id": "statin-prescriptions-cholesterol-muscle-pain-coq10",
  "slug": "statin-prescriptions-cholesterol-muscle-pain-coq10",
  ...
  "excerpt": "A comprehensive patient guide to statin prescriptions and cardiovascular health: atorvastatin vs. rosuvastatin, muscle pain myths, and the truth about coq10: clinical mechanisms, dosage timing, organ safety, and evidence-based guidance.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "content": [
        "• <a href=\"https://www.acc.org/guidelines\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 font-bold underline decoration-red-500/40 hover:decoration-red-400 transition-colors\">American College of Cardiology (ACC) - Guideline on the Management of Blood Cholesterol</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://pubmed.ncbi.nlm.nih.gov/36049498/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 font-bold underline decoration-red-500/40 hover:decoration-red-400 transition-colors\">The Lancet via PubMed - Adverse Effects of Statin Therapy: Perception vs. The Evidence from Clinical Trials</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://www.lipid.org/scientific-statements\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 font-bold underline decoration-red-500/40 hover:decoration-red-400 transition-colors\">National Lipid Association (NLA) - Assessment and Management of Statin-Associated Muscle Symptoms (SAMS)</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://www.mayoclinic.org/diseases-conditions/high-blood-cholesterol/in-depth/statin-side-effects/art-20046013\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 font-bold underline decoration-red-500/40 hover:decoration-red-400 transition-colors\">Mayo Clinic Cardiovascular Review - Statin Side Effects: Weigh the Benefits and Risks</a>: Evidence-based clinical guidelines and regulatory safety communications."
      ]
    }
  ],
