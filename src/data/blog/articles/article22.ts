...
export const article22: BlogArticle = {
  "id": "antidepressant-prescriptions-ssri-snri-tapering-guide",
  "slug": "antidepressant-prescriptions-ssri-snri-tapering-guide",
  ...
  "excerpt": "A comprehensive patient guide to the patient guide to antidepressant prescriptions: ssris, snris, how they work, and the science of safe tapering: clinical mechanisms, dosage timing, organ safety, and evidence-based guidance.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "content": [
        "• <a href=\"https://www.nimh.nih.gov/health/topics/mental-health-medications\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-bold underline decoration-purple-500/40 hover:decoration-purple-400 transition-colors\">National Institute of Mental Health (NIMH) - Mental Health Medications: Antidepressant Classes and Action Mechanisms</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://pubmed.ncbi.nlm.nih.gov/29477251/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-bold underline decoration-purple-500/40 hover:decoration-purple-400 transition-colors\">The Lancet via PubMed - Comparative Efficacy and Acceptability of 21 Antidepressant Drugs for the Acute Treatment of Adults</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://www.rcpsych.ac.uk/mental-health/treatments-and-wellbeing/stopping-antidepressants\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-bold underline decoration-purple-500/40 hover:decoration-purple-400 transition-colors\">Royal College of Psychiatrists - Stopping Antidepressants: Practical Patient Guide on Tapering and Discontinuation</a>: Evidence-based clinical guidelines and regulatory safety communications.",
        "• <a href=\"https://www.mayoclinic.org/diseases-conditions/depression/expert-answers/antidepressant-withdrawal/faq-20058133\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-bold underline decoration-purple-500/40 hover:decoration-purple-400 transition-colors\">Mayo Clinic Mental Health - Antidepressant Withdrawal: Is There Such a Thing?</a>: Evidence-based clinical guidelines and regulatory safety communications."
      ]
    }
  ],
