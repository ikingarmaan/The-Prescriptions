    ...
    <div className="w-full mx-auto py-2 sm:py-6 animate-in fade-in duration-200">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
        <button
          ...
          className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-emerald-700 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 transition-colors w-fit p-1 -ml-1 rounded-lg hover:bg-emerald-50 dark:hover:bg-emerald-950/40 cursor-pointer"
        >
      ...
      {currentPage === 'about' && (
        <div className="space-y-10 text-slate-800 dark:text-slate-200 leading-relaxed">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 flex items-center justify-center font-black shrink-0">
                1
              </div>
              <div>
                <span className="text-[11px] font-black uppercase tracking-wider text-emerald-700 dark:text-emerald-400">The Problem We Address</span>
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-teal-100 dark:bg-teal-900/40 text-teal-700 dark:text-teal-400 flex items-center justify-center font-black shrink-0">
                2
              </div>
              <div>
                <span className="text-[11px] font-black uppercase tracking-wider text-teal-700 dark:text-teal-400">Clinical Empathy</span>
                <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
            ...
            <div className="bg-slate-50 dark:bg-slate-800/60 p-5 rounded-xl border border-slate-200 dark:border-slate-800 space-y-2">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-400 flex items-center justify-center font-black shrink-0">
                3
              </div>
              <div>
                <span className="text-[11px] font-black uppercase tracking-wider text-blue-700 dark:text-blue-400">Engineering Innovation</span>
                <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 space-y-2">
                <span className="font-mono font-bold text-blue-800 dark:text-blue-300 text-xs uppercase bg-blue-100 dark:bg-blue-900/40 px-2 py-0.5 rounded-md">
                  Stage 1: Image Enhancement
                </span>
                <h4 className="font-bold text-slate-900 dark:text-white">Adaptive Bilateral Filtering</h4>
              ...
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 space-y-2">
                ...
                <h4 className="font-bold text-slate-900 dark:text-white">Contextual Ligature Parsing</h4>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 space-y-2">
                ...
                <h4 className="font-bold text-slate-900 dark:text-white">Generic Salt Mapping</h4>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-400 flex items-center justify-center font-black shrink-0">
                4
              </div>
              <div>
                <span className="text-[11px] font-black uppercase tracking-wider text-purple-700 dark:text-purple-400">Patient Dignity</span>
                <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-amber-100 text-amber-700 dark:text-amber-400 flex items-center justify-center font-black shrink-0">
                5
              </div>
              <div>
                <span className="text-[11px] font-black uppercase tracking-wider text-amber-700 dark:text-amber-400">Safety First</span>
                <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-slate-700 dark:text-slate-300 pt-2">
              <div className="flex items-start gap-3 bg-slate-50 dark:bg-slate-800/60 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                <div>
                  <strong className="block text-slate-900 dark:text-white font-semibold mb-1">Zero Commercial Bias</strong>
              ...
              <div className="flex items-start gap-3 bg-slate-50 dark:bg-slate-800/60 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                <div>
                  <strong className="block text-slate-900 dark:text-white font-semibold mb-1">Printable Medication Cards</strong>
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-[11px] font-black uppercase tracking-wider text-teal-700 dark:text-teal-400">Financial Health Literacy</span>
                <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-rose-100 text-rose-700 dark:text-rose-400 flex items-center justify-center font-black shrink-0">
                7
              </div>
              <div>
                <span className="text-[11px] font-black uppercase tracking-wider text-rose-700 dark:text-rose-400">Vulnerable Populations</span>
                <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-[11px] font-black uppercase tracking-wider text-emerald-700 dark:text-emerald-400">Ethical Standards</span>
                <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 text-xs text-slate-700 dark:text-slate-300">
              <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">1. Patient Primacy</strong>
              ...
              <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">2. Ephemeral Data Dignity</strong>
                We refuse to monetize, archive, or broker medical documents. What happens in volatile memory stays in volatile memory.
              </div>
              <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">3. Clinical Modesty</strong>
              ...
              <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">4. Pharmacological Integrity</strong>
              ...
              <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">5. Radical Accessibility</strong>
              ...
              <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">6. Continuous Algorithmic Auditing</strong>
              ...
              <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 col-span-1 md:col-span-2">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">7. Unwavering Pharmacist Partnership</strong>
      ...
      {currentPage === 'disclaimer' && (
        <div className="space-y-8 text-slate-800 dark:text-slate-200 leading-relaxed">
          {/* Hero Warning Banner */}
          <div className="bg-rose-50 dark:bg-rose-950/40 border-2 border-rose-300 dark:border-rose-800 p-6 sm:p-8 rounded-3xl shadow-sm space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h1 className="text-xl sm:text-3xl font-black text-rose-950 dark:text-rose-100">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <div className="p-4 rounded-xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800/60 text-xs text-rose-900 dark:text-rose-200 font-semibold">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-slate-700 dark:text-slate-300">
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Step 1: Do Not Consume the Medication</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Step 2: Compare Against the Physical Pharmacy Label</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Step 3: Call Your Dispensing Pharmacy Directly</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Step 4: Contact Your Prescribing Doctor Clinic</strong>
        ...
        <div className="space-y-10 text-slate-800 dark:text-slate-200 leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 space-y-4">
              <h3 className="font-bold text-slate-900 dark:text-white text-base">Direct Clinical &amp; Technical Channels</h3>
              ...
              <div className="p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1.5">
                <div className="flex items-center gap-2.5 text-blue-700 dark:text-blue-400 font-bold text-sm">
                  <Mail className="w-4 h-4" />
                  <span>General Support &amp; Feedback</span>
                </div>
                <a href="mailto:Theprescriptionn@gmail.com?subject=General%20Support" className="text-xs font-mono text-blue-700 dark:text-blue-400 font-semibold hover:underline block">Theprescriptionn@gmail.com</a>
              ...
              <div className="p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1.5">
                <div className="flex items-center gap-2.5 text-purple-700 dark:text-purple-400 font-bold text-sm">
                  <Stethoscope className="w-4 h-4" />
                  <span>Pharmacist &amp; Clinical Advisory Network</span>
                </div>
                <a href="mailto:Theprescriptionn@gmail.com?subject=Clinical%20Advisory" className="text-xs font-mono text-purple-700 dark:text-purple-400 font-semibold hover:underline block">Theprescriptionn@gmail.com</a>
                <p className="text-[11px] text-slate-500 dark:text-slate-400">
              ...
              <div className="p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1.5">
                ...
                <a href="mailto:Theprescriptionn@gmail.com?subject=Developer%20Inquiry" className="text-xs font-mono text-emerald-700 dark:text-emerald-400 font-semibold hover:underline block">Theprescriptionn@gmail.com</a>
                <p className="text-[11px] text-slate-500 dark:text-slate-400">
              ...
              <div className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
                {contactSubmitted ? (
                  <div className="py-10 text-center space-y-4 animate-in fade-in">
                    <div className="w-14 h-14 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-600 flex items-center justify-center mx-auto shadow-xs">
                      <CheckCircle2 className="w-8 h-8" />
                    </div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white">Message Successfully Dispatched!</h3>
                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 max-w-md mx-auto leading-relaxed">
                      Thank you for contacting Theprescription team. Your message has been routed directly to our inbox at <strong className="text-slate-900 dark:text-white font-semibold">Theprescriptionn@gmail.com</strong>.
                    </p>
                    <div className="p-3.5 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200/80 rounded-xl text-xs text-emerald-950 dark:text-emerald-100 max-w-md mx-auto leading-relaxed">
                      <span>An automated confirmation receipt has also been sent to <strong className="font-semibold text-emerald-900 dark:text-emerald-200">{contactForm.email}</strong>. Our clinical and software advisory team will review your inquiry shortly.</span>
                    </div>
                    <button
                      type="button"
                      onClick={() => {
                  ...
                  <form onSubmit={handleContactSubmit} className="space-y-4">
                    <h3 className="font-bold text-slate-900 dark:text-white text-base sm:text-lg">Send Our Team a Direct Message</h3>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800/60 border border-slate-300 dark:border-slate-700 rounded-xl text-xs sm:text-sm focus:bg-white dark:focus:bg-slate-900 text-slate-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:outline-hidden"
                      />
                    </div>
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <ul className="space-y-1.5 text-xs sm:text-sm text-slate-700 dark:text-slate-300 list-disc pl-5">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-slate-700 dark:text-slate-300">
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Blurry or Out-of-Focus Photos</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Harsh Shadows &amp; Glare</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Crumpled or Folded Paper Slips</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Supported File Formats &amp; File Sizes</strong>
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-slate-700 dark:text-slate-300">
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Phrasing Tip 1: The Repeat-Back Technique</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Phrasing Tip 2: The Generic Confirmation</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Phrasing Tip 3: Food Timing Specificity</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Phrasing Tip 4: Duration and Refills</strong>
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <div className="space-y-2.5 text-xs text-slate-700 dark:text-slate-300">
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-0.5">Why does my uploaded prescription show &quot;Unable to decipher&quot;?</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-0.5">Can I upload PDF digital hospital discharge summaries?</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-0.5">Does Theprescription require an internet connection?</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-0.5">Can I use the platform on my smartphone?</strong>
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
              For interviews, background briefings, high-resolution brand assets, or conference speaking engagements, please send an email with the subject line <strong>&quot;Media Inquiry&quot;</strong> to <a href="mailto:Theprescriptionn@gmail.com?subject=Media%20Inquiry" className="font-mono text-emerald-700 dark:text-emerald-400 font-semibold hover:underline">Theprescriptionn@gmail.com</a> including your publication name, interview format, and deadline.
            </p>
          </section>
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-slate-700 dark:text-slate-300">
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">High-Contrast Large Print Mode</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Color-Coded Circadian Pill Icons</strong>
            ...
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
              If you are an assisted-living facility coordinator or geriatric social worker seeking customized printable templates for your community residents, contact our community outreach liaison at <a href="mailto:Theprescriptionn@gmail.com?subject=Community%20Outreach" className="font-mono text-rose-700 dark:text-rose-400 font-semibold hover:underline">Theprescriptionn@gmail.com</a>.
            </p>
          </section>
      ...
      {currentPage === 'privacy' && (
        <div className="space-y-8 text-slate-800 dark:text-slate-200 leading-relaxed">
          {/* Header */}
          <div className="bg-white dark:bg-slate-900 p-6 sm:p-10 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <div className="p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/60 text-xs text-emerald-950 dark:text-emerald-100 font-semibold">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <div className="overflow-x-auto my-2">
              <table className="w-full text-left text-xs border-collapse border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden">
                <thead className="bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white font-bold border-b border-slate-200 dark:border-slate-800">
                  <tr>
                    <th className="p-3">Privacy Dimension</th>
                    <th className="p-3">Mainstream Health Apps &amp; Portals</th>
                    <th className="p-3 text-emerald-900 dark:text-emerald-200 bg-emerald-50 dark:bg-emerald-950/30">Theprescription Architecture</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 text-slate-700 dark:text-slate-300">
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-semibold text-slate-900 dark:text-white">Document Image Archival</td>
                    <td className="p-3">Stored indefinitely in cloud buckets to train internal models.</td>
                    <td className="p-3 bg-emerald-50/50 font-semibold text-emerald-900 dark:text-emerald-200">Zero disk storage. Immediately purged from volatile RAM.</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-semibold text-slate-900 dark:text-white">User Account Registration</td>
                    <td className="p-3">Requires email, phone number, real name, and password.</td>
                    <td className="p-3 bg-emerald-50/50 font-semibold text-emerald-900 dark:text-emerald-200">100% account-free. No registration, no passwords, no email collection.</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-semibold text-slate-900 dark:text-white">Advertising &amp; Retargeting</td>
                    <td className="p-3">Monetizes search queries to serve targeted pharmaceutical ads.</td>
                    <td className="p-3 bg-emerald-50/50 font-semibold text-emerald-900 dark:text-emerald-200">Zero trackers, zero ads, zero data brokering.</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-semibold text-slate-900 dark:text-white">AI Model Retraining</td>
                    <td className="p-3">Uses patient documents to fine-tune future public models.</td>
                    <td className="p-3 bg-emerald-50/50 font-semibold text-emerald-900 dark:text-emerald-200">Explicit enterprise exemption: zero customer data used for training.</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs text-slate-700 dark:text-slate-300">
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Method 1: Physical Paper Masking</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Method 2: Smartphone Digital Crop</strong>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800">
                <strong className="text-slate-900 dark:text-white block font-bold mb-1">Method 3: Direct Text Input</strong>
      ...
      {currentPage === 'terms' && (
        <div className="space-y-8 text-slate-800 dark:text-slate-200 leading-relaxed">
          ...
          {/* Section 1 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">1. Acceptance of Terms &amp; Binding Legal Covenant</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          {/* Section 2 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">2. Informational &amp; Health-Literacy Scope: No Practice of Medicine</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          {/* Section 3 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">3. User Eligibility, Age Requirements &amp; Dependent Representation</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          {/* Section 4 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">4. Intellectual Property Rights &amp; Proprietary Assets</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          {/* Section 5 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">5. Prohibited Conduct &amp; Platform Misuse</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          {/* Section 6 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">6. Disclaimer of Warranties (&quot;As-Is&quot; Provision)</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          {/* Section 7 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">7. Comprehensive Limitation of Liability</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          {/* Section 8 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">8. User Indemnification Obligations</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          {/* Section 9 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">9. Service Modifications &amp; Unilateral Termination Rights</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          {/* Section 10 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">10. Third-Party Web Links &amp; Pharmacopeial References</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          {/* Section 11 */}
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">11. Severability, Entire Agreement &amp; Non-Waiver</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">13. Prohibited Use in Acute Clinical Emergencies</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">14. Algorithmic Transparency &amp; Human-in-the-Loop Affirmation</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">15. Telehealth &amp; Electronic Medical Records (EMR) Interoperability</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">16. International Sanctions &amp; Export Control Compliance</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">17. Strict Prohibition of Prescription Alteration, Forgery &amp; Drug Diversion</h2>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
