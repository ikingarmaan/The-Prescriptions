  ...
  return (
    <div id="abbreviation-dictionary-root" className="w-full mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl border border-slate-200/90 dark:border-slate-800 shadow-sm overflow-hidden">
        ...
        <div className="p-5 sm:p-7 md:p-8 bg-white dark:bg-slate-900">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            {filteredAbbreviations.map((item, idx) => (
              <div
                key={idx}
                className="p-4 rounded-xl border border-slate-200/90 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-800/40 hover:bg-white dark:hover:bg-slate-800/80 hover:border-purple-300 dark:hover:border-purple-600 hover:shadow-2xs transition-all flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-base font-bold font-mono text-purple-800 dark:text-purple-300 bg-purple-50 dark:bg-purple-950/60 px-2.5 py-0.5 rounded-md border border-purple-200 dark:border-purple-800">
                      {item.abbr}
                    </span>
                    {item.fullLatin && (
                  ...
                  <h4 className="text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200 mb-1">
                    {item.englishMeaning}
                  </h4>
                </div>
              <div className="mt-2 pt-2 border-t border-slate-100 dark:border-slate-800 text-[11px] text-slate-500 dark:text-slate-400">
                <span className="font-medium text-slate-600 dark:text-slate-300">Prescription example: </span>
                {item.example}
              </div>
            </div>
          ))}
      ...
      <section className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200 space-y-10 leading-relaxed">
        ...
        <header className="space-y-3 text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-100 dark:bg-purple-950/60 text-purple-800 dark:text-purple-300 text-xs font-black uppercase tracking-wider border border-purple-300 dark:border-purple-800">
        ...
        <article className="space-y-4 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[11px] font-black uppercase tracking-wider text-purple-700 dark:text-purple-400">Historical Foundations</span>
        ...
        <article className="space-y-4 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[11px] font-black uppercase tracking-wider text-blue-700 dark:text-blue-400">Frequency Analysis</span>
              <h3 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs sm:text-sm my-3">
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/80 space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-mono font-bold text-base text-blue-900 dark:text-blue-300">OD (Omni Die) / QD</span>
                <span className="text-[11px] text-slate-500 dark:text-slate-400 font-serif italic">omni die</span>
              </div>
              <h4 className="font-bold text-slate-900 dark:text-white">Once Daily (Every 24 Hours)</h4>
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/80 space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-mono font-bold text-base text-blue-900 dark:text-blue-300">BD / BID (Bis in Die)</span>
                <span className="text-[11px] text-slate-500 dark:text-slate-400 font-serif italic">bis in die</span>
              </div>
              <h4 className="font-bold text-slate-900 dark:text-white">Twice Daily (Every 12 Hours)</h4>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-xs">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/80 space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-mono font-bold text-base text-blue-900 dark:text-blue-300">TDS / TID (Ter Die Sumendum)</span>
                <span className="text-[11px] text-slate-500 dark:text-slate-400 font-serif italic">ter die sumendum</span>
              </div>
              <h4 className="font-bold text-slate-900 dark:text-white">Three Times Daily (Every 8 Hours)</h4>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-xs">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/80 space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-mono font-bold text-base text-blue-900 dark:text-blue-300">QDS / QID (Quater in Die)</span>
                <span className="text-[11px] text-slate-500 dark:text-slate-400 font-serif italic">quater in die</span>
              </div>
              <h4 className="font-bold text-slate-900 dark:text-white">Four Times Daily (Every 6 Hours)</h4>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-xs">
        ...
        <article className="space-y-4 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[11px] font-black uppercase tracking-wider text-emerald-700 dark:text-emerald-400">Circadian Grids</span>
              <h3 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
            ...
            <table className="w-full text-left text-xs border-collapse border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-700 text-slate-700 dark:text-slate-300">
                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                  <td className="p-3 font-mono font-bold text-emerald-800 dark:text-emerald-400">1 - 0 - 1</td>
                  <td className="p-3">1 tablet</td>
                  <td className="p-3">0</td>
                  <td className="p-3">1 tablet</td>
                  <td className="p-3 font-semibold text-slate-900 dark:text-white">2 tablets</td>
                  <td className="p-3">Metformin 500mg, Amoxicillin/Clavulanate 625mg, Aceclofenac</td>
                </tr>
                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                  <td className="p-3 font-mono font-bold text-emerald-800 dark:text-emerald-400">1 - 0 - 0</td>
                  <td className="p-3">1 tablet</td>
                  <td className="p-3">0</td>
                  <td className="p-3">0</td>
                  <td className="p-3 font-semibold text-slate-900 dark:text-white">1 tablet</td>
                  <td className="p-3">Levothyroxine, Pantoprazole, Amlodipine, Multivitamins</td>
                </tr>
                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                  <td className="p-3 font-mono font-bold text-emerald-800 dark:text-emerald-400">1 - 1 - 1</td>
                  <td className="p-3">1 tablet</td>
                  <td className="p-3">1 tablet</td>
                  <td className="p-3">1 tablet</td>
                  <td className="p-3 font-semibold text-slate-900 dark:text-white">3 tablets</td>
                  <td className="p-3">Digestive enzymes, short-acting antibiotics, Ibuprofen 400mg</td>
                </tr>
                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                  <td className="p-3 font-mono font-bold text-emerald-800 dark:text-emerald-400">0 - 0 - 1</td>
                  <td className="p-3">0</td>
                  <td className="p-3">0</td>
                  <td className="p-3">1 tablet</td>
                  <td className="p-3 font-semibold text-slate-900 dark:text-white">1 tablet</td>
                ...
                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                  <td className="p-3 font-mono font-bold text-emerald-800 dark:text-emerald-400">0 - 1 - 0</td>
                  <td className="p-3">0</td>
                  <td className="p-3">1 tablet</td>
                  <td className="p-3">0</td>
                  <td className="p-3 font-semibold text-slate-900 dark:text-white">1 tablet</td>
                ...
                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                  <td className="p-3 font-mono font-bold text-emerald-800 dark:text-emerald-400">1 - 1 - 1 - 1</td>
                  <td className="p-3" colSpan={3}>Four evenly distributed doses across morning, noon, evening, bedtime</td>
                  <td className="p-3 font-semibold text-slate-900 dark:text-white">4 tablets</td>
        ...
        <article className="space-y-4 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[11px] font-black uppercase tracking-wider text-teal-700 dark:text-teal-400">Meal Directives</span>
              <h3 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-teal-50 dark:bg-teal-950/30 border border-teal-200 dark:border-teal-800/60 space-y-2">
              <strong className="text-teal-900 dark:text-teal-300 font-bold block text-sm">AC — Ante Cibum (Before Meals)</strong>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-xs">
            ...
            <div className="p-4 rounded-xl bg-teal-50 dark:bg-teal-950/30 border border-teal-200 dark:border-teal-800/60 space-y-2">
              <strong className="text-teal-900 dark:text-teal-300 font-bold block text-sm">PC — Post Cibum (After Meals)</strong>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-xs">
        ...
        <article className="space-y-4 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[11px] font-black uppercase tracking-wider text-amber-700 dark:text-amber-400">As-Needed Medication</span>
              <h3 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs sm:text-sm my-2">
            <div className="p-4 rounded-xl bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/60 space-y-2">
              <span className="font-mono font-bold text-amber-900 dark:text-amber-300 text-sm">PRN (Pro Re Nata)</span>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-xs">
            ...
            <div className="p-4 rounded-xl bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/60 space-y-2">
              <span className="font-mono font-bold text-amber-900 dark:text-amber-300 text-sm">SOS (Si Opus Sit)</span>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-xs">
        ...
        <article className="space-y-4 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[11px] font-black uppercase tracking-wider text-slate-600 dark:text-slate-400">Routes of Ingestion</span>
              <h3 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2.5 text-xs">
            <div className="bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-200 dark:border-slate-700/80">
              <span className="font-mono font-bold text-slate-900 dark:text-white block mb-0.5">PO (Per Os)</span>
              <span className="text-slate-600 dark:text-slate-300">By mouth (swallowed orally with water).</span>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-200 dark:border-slate-700/80">
              <span className="font-mono font-bold text-slate-900 dark:text-white block mb-0.5">SL (Sub Lingua)</span>
              <span className="text-slate-600 dark:text-slate-300">Dissolved under the tongue.</span>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-200 dark:border-slate-700/80">
              <span className="font-mono font-bold text-slate-900 dark:text-white block mb-0.5">IV (Intravenous)</span>
              <span className="text-slate-600 dark:text-slate-300">Injected directly into a vein.</span>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-200 dark:border-slate-700/80">
              <span className="font-mono font-bold text-slate-900 dark:text-white block mb-0.5">IM (Intramuscular)</span>
              <span className="text-slate-600 dark:text-slate-300">Injected deep into muscle tissue.</span>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-200 dark:border-slate-700/80">
              <span className="font-mono font-bold text-slate-900 dark:text-white block mb-0.5">SC / SubQ</span>
              <span className="text-slate-600 dark:text-slate-300">Injected subcutaneously under skin.</span>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-200 dark:border-slate-700/80">
              <span className="font-mono font-bold text-slate-900 dark:text-white block mb-0.5">PR (Per Rectum)</span>
              <span className="text-slate-600 dark:text-slate-300">Rectal suppository administration.</span>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-200 dark:border-slate-700/80">
              <span className="font-mono font-bold text-slate-900 dark:text-white block mb-0.5">Top (Topical)</span>
              <span className="text-slate-600 dark:text-slate-300">Applied directly to cutaneous skin.</span>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-200 dark:border-slate-700/80">
              <span className="font-mono font-bold text-slate-900 dark:text-white block mb-0.5">Inh (Inhalation)</span>
              <span className="text-slate-600 dark:text-slate-300">Inhaled into lungs via MDI/DPI.</span>
            </div>
          </div>
        </article>
        ...
        <article className="space-y-4 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[11px] font-black uppercase tracking-wider text-rose-700 dark:text-rose-400">Patient Safety Imperative</span>
              <h3 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
          ...
          <div className="space-y-2.5 text-xs text-slate-700 dark:text-slate-300">
            <div className="p-3 rounded-xl bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900/60 flex items-start gap-2.5">
              <span className="font-mono font-bold text-rose-800 dark:text-rose-300 bg-rose-100 dark:bg-rose-950/60 px-2 py-0.5 rounded text-xs shrink-0">
                U or u (Unit)
              </span>
              <div>
                <strong className="text-rose-950 dark:text-rose-200 font-bold block">Danger: Mistaken for &quot;0&quot;, &quot;4&quot;, or &quot;cc&quot;</strong>
            ...
            <div className="p-3 rounded-xl bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900/60 flex items-start gap-2.5">
              ...
              <div>
                <strong className="text-rose-950 dark:text-rose-200 font-bold block">Danger: Overdoses by a factor of ten</strong>
            ...
            <div className="p-3 rounded-xl bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900/60 flex items-start gap-2.5">
              ...
              <div>
                <strong className="text-rose-950 dark:text-rose-200 font-bold block">Danger: Confused for each other or &quot;QID&quot;</strong>
            ...
            <div className="p-3 rounded-xl bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900/60 flex items-start gap-2.5">
              ...
              <div>
                <strong className="text-rose-950 dark:text-rose-200 font-bold block">Danger: Confusing Morphine Sulfate with Magnesium Sulfate</strong>
