...
export const PrescriptionMasterBox: React.FC<PrescriptionMasterBoxProps> = ({
  ...
  return (
    <div
      ...
      className={`bg-white rounded-3xl border-2 border-emerald-500/30 shadow-sm overflow-hidden ${className}`}
    >
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse text-xs sm:text-sm">
          <thead>
            <tr className="bg-slate-100/80 border-b border-slate-200 text-slate-700 font-bold uppercase tracking-wider text-[10px] sm:text-xs">
            ...
            {medicines.map((med, idx) => (
              ...
              >
                ...
                <td className="py-3.5 px-3">
                  ...
                  {med.timingCode && (
                    <span className="inline-block mt-0.5 px-1.5 py-0.5 rounded bg-blue-50 text-blue-700 font-mono text-[10px] border border-blue-200">
                      {med.timingCode}
                    </span>
                  )}
                </td>
